...
export default function Task() {
  const navigation = useNavigation(); // Now you have access to navigation
  
  const [items, setItems] = useState({
    '2024-05-14': [{ name: 'Meeting with client', time: '10:00 AM To 11:00 AM', task: 'Discuss project updates' }],
    '2024-04-30': [
      { name: 'Team brainstorming session', time: '9:00 AM', task: 'Plan upcoming tasks' },
      { name: 'Project presentation', time: '2:00 PM', task: 'Present project progress' },
      { name: 'Project presentation', time: '5:00 PM', task: 'Review feedback' }
    ],
    '2024-05-15': [
      { name: 'Team brainstorming session', time: '9:00 AM', task: 'Discuss project strategies' },
      { name: 'Project presentation', time: '2:00 PM', task: 'Finalize project plan' }
    ],
    '2024-05-13': [
      { name: 'Team brainstorming session', time: '9:00 AM', task: 'Brainstorm new ideas' },
      { name: 'Project presentation', time: '2:00 PM', task: 'Review project milestones' }
    ],
  });
